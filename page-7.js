import"./assets/styles-q4qmUVT2.js";console.log("page 07. Infinite scroll");let c=1;function o(){fetch(`https://rickandmortyapi.com/api/character/?page=${c}`).then(e=>e.json()).then(e=>{const{results:n}=e,r=n.map(t=>`
            <li>
               <img src="${t.image}" alt="">
               <p>NAME: ${t.name}</p>
               <p>GENDER: ${t.gender}</p>
