import"./assets/styles-O95wUiJ_.js";const i="c7cfa9764acc40e0977baf4dd8dae782",h="https://newsapi.org/v2/everything";class l{constructor(){this.searchQuery="",this.page=1}fetchArticles(){console.log(this);const e={headers:{Authorization:i}},r=`${h}?q=${this.searchQuery}&language=en&pageSize=5&page=${this.page}`;return fetch(r,e).then(s=>s.json()).then(s=>(this.incrementPage(),s.articles))}incrementPage(){this.page+=1}resetPage(){this.page=1}get query(){return this.searchQuery}set query(e){this.searchQuery=e}}class u{constructor({selector:e,hidden:r=!1}){this.refs=this.getRefs(e),r&&this.hide()}getRefs(e){const r={};return r.button=document.querySelector(e),r}show(){this.refs.button.classList.remove("is-hidden")}hide(){this.refs.button.classList.add("is-hidden")}}const a={articlesContainer:document.querySelector(".js-articles-container")};function o(t){const e=`
        <li class="li_back">
